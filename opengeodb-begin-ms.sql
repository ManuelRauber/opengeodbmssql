create table geodb_type_names (
  ...
  name                 nvarchar(255) not null,             /* varchar(500)? */
...
create table geodb_textdata (
  ...
  text_val             nvarchar(255) not null,                  /* varchar(2000)? */
...
create table geodb_floatdata (
  ...
  valid_since          varchar(50),					-- mysql allows 0 for date value, mssql does not; originally "date",
  date_type_since      integer,
  valid_until          date not null,
  date_type_until      integer not null
);
